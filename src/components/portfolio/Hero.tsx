...
export function Hero() {
  return (
    <section
      id="home"
      className="relative mx-auto w-full max-w-6xl px-5 pb-16 pt-28 sm:px-8 sm:pb-24 sm:pt-36"
    >
      <div className="grid items-center gap-12 lg:grid-cols-[1.15fr_0.85fr]">
        <Reveal>
          ...
          <p className="mt-4 font-display text-sm text-foreground/80 sm:text-base">
            {profile.tagline}
          </p>
        ...
        <Reveal delay={120} className="justify-self-center">
          <div className="relative h-64 w-64 sm:h-80 sm:w-80">
            ...
            <div
              className="animate-float-soft absolute inset-0 rounded-full p-[2px]"
              style={{ backgroundImage: "var(--gradient-brand)" }}
            >
